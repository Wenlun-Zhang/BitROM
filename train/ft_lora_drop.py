...
parser.add_argument('--save_dir', type=str, default='./lora_ft_model/drop/Falcon3_158_7B_16r_vod_w6a8', help='Save Output LoRA Model Directory')
...
# =====================
# Load DROP Dataset (Train and Validation)
# =====================
dataset = load_dataset("drop")

# =====================
# Data Preprocess Function
# Concatenate Passage and Question as Prompt, and add Answer as hint
...
def preprocess_function(example):
    prompt = "Passage: " + example["passage"].strip() + "\nQuestion: " + example["question"].strip() + "\nAnswer: "
    if not example["answers_spans"]["spans"]:
        target = "No Answer " + tokenizer.eos_token
    else:
        target = example["answers_spans"]["spans"][0].strip() + " " + tokenizer.eos_token
