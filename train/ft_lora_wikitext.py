...
parser.add_argument('--save_dir', type=str, default='./lora_ft_model/wikitext/Falcon3_158_7B_16r_vod_w6a8', help='Save Output LoRA Model Directory')
...
for epoch in range(args.epoch):
    ...
    with torch.no_grad():
        for batch in val_dataloader:
            ...
            outputs = model(**batch)
            loss = outputs.loss
            # Assume loss per token, then total loss times token count
