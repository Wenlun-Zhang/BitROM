...
parser.add_argument('--eval_base', action='store_true', default=True, help='Evaluate Base Model')
parser.add_argument('--eval_lora', action='store_true', default=True, help='Evaluate LoRA Model')
...
parser.add_argument('--dataset', type=str, default='WikiText2', help='Select Dataset: WikiText2 or WikiText103')
...
# =====================
# Load Tokenizer and Prepare Data for WikiText-2
# =====================
...
# =====================
# Load WikiText Dataset (Train and Validation)
# =====================
if args.dataset == 'WikiText2':
    ...
    raise NotImplementedError("Select WikiText2 or WikiText103")
